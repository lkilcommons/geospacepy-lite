...
A small library of python functions useful for geospace data analysis. This package is particularly focused on being approachable for students or researchers less familiar with Python, and tries to have in-depth documentation and to require only familiarity with core Python and numpy to use. 
