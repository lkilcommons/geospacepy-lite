...
def testjd2gst():
	...
	jd_ut1 = ymdhms2jd(y,mo,d,h,m,s)
	print "JD is %.6f, should be 2448855.009722" % (jd_ut1)
	#assert(abs(jd_ut1-2448855.009722)<.00001)
	theta_gst = jd2gst(jd_ut1,deg=True)
	print "Theta GST is %.9f, reference value is 152.578787886" % theta_gst
	#assert(abs(theta_gst-152.578787886)<.00001)
